...
export const Home: React.FC<HomeProps> = () => {
  ...
  const defaultValue = Boolean(localStorage.getItem('usehooks-ts-dark-mode'));
  ...
  const inputClassname = isDarkMode
    ...
    : "p-2 border-none focus:outline-none font-semibold bg-[#d6ccc2] text-[#976A6D]";
  ...
  return (
    <div
      className={cn(`min-h-screen bg-[#edede9] text-[#9c9186] dark:bg-card dark:text-primary ${isDarkMode ? "dark" : "light"}`)}
    >
